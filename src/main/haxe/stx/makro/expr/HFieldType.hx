...
abstract HFieldType(StdFieldType) from StdFieldType to StdFieldType{
  ...
  static public function FVar( t : Null<HComplexType>, ?e : Null<HExpr> ){
	...
	static public function FProp( get : String, set : String, ?t : Null<HComplexType>, ?e : Null<HExpr> ){
    return lift(StdFieldType.FProp(get,set,__.option(t).map((t:HComplexType) -> t.prj()).defv(null),__.option(e).map(e -> e.prj()).defv(null)));
  }
}
