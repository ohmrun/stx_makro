...
@:forward abstract HFieldType(StdFieldType) from StdFieldType to StdFieldType{
  ...
  static public function FVar( t : Null<stx.makro.expr.HComplexType>, ?e : Null<stx.makro.expr.HExpr> ){
	...
	static public function FProp( get : stx.makro.expr.HPropAccess, set : stx.makro.expr.HPropAccess, ?t : Null<stx.makro.expr.HComplexType>, ?e : Null<stx.makro.expr.HExpr> ){
