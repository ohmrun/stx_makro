...
import stx.assert.makro.type.ord.*;
...
class Ord extends Clazz{
  ...
  @:isVar public var ClassField(get,null):stx.assert.makro.type.ord.ClassField;
  private function get_ClassField():stx.assert.makro.type.ord.ClassField{
    return __.option(this.ClassField).def(() -> this.ClassField = new stx.assert.makro.type.ord.ClassField());
  }
  @:isVar public var AnonStatus(get,null):stx.assert.makro.type.ord.AnonStatus;
  private function get_AnonStatus():stx.assert.makro.type.ord.AnonStatus{
    return __.option(this.AnonStatus).def(() -> this.AnonStatus = new stx.assert.makro.type.ord.AnonStatus());
  }
  @:isVar public var Type(get,null):stx.assert.makro.type.ord.Type;
  private function get_Type():stx.assert.makro.type.ord.Type{
    return __.option(this.Type).def(() -> this.Type = new stx.assert.makro.type.ord.Type());
  }
