...
stx_macro_QuoteTest.prototype = {
	...
	,test: function() {
		haxe_Log.trace("___________",{ fileName : "QuoteTest.hx", lineNumber : 37, className : "stx.macro.QuoteTest", methodName : "test"});
		var out = { expr : Type.createEnum(Type.resolveEnum("haxe.macro.ExprDef"),"EBlock",[[{ expr : Type.createEnum(Type.resolveEnum("haxe.macro.ExprDef"),"ECall",[{ expr : Type.createEnum(Type.resolveEnum("haxe.macro.ExprDef"),"EConst",[Type.createEnum(Type.resolveEnum("haxe.macro.Constant"),"CIdent",["trace"])]), pos : { }},[{ expr : Type.createEnum(Type.resolveEnum("haxe.macro.ExprDef"),"EConst",[Type.createEnum(Type.resolveEnum("haxe.macro.Constant"),"CString",["HERLO"])]), pos : { }}]]), pos : { }}]]), pos : { }};
		haxe_Log.trace("___________",{ fileName : "QuoteTest.hx", lineNumber : 41, className : "stx.macro.QuoteTest", methodName : "test"});
		haxe_Log.trace(out,{ fileName : "QuoteTest.hx", lineNumber : 43, className : "stx.macro.QuoteTest", methodName : "test"});
		haxe_Log.trace("___________",{ fileName : "QuoteTest.hx", lineNumber : 45, className : "stx.macro.QuoteTest", methodName : "test"});
	}
...
stx_macro_Quote.map = new haxe_ds_StringMap();
